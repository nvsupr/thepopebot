...
export async function getWorkspaceDiffStats(workspaceId) {
  const { getWorkspaceDiffStats: getDiffStats } = await import('../code/actions.js');
  return getDiffStats(workspaceId);
}
